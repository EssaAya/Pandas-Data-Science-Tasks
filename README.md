...
To access all of the files I recommend you fork this repo and then clone it locally (That is what I actually did). Instructions on how to do this can be found here: https://help.github.com/en/github/getting-started-with-github/fork-a-repo
